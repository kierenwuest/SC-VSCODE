...
exports.checkAndUpdateSfCli = exports.deactivate = exports.activate = void 0;
...
const attachSaveListener_1 = __webpack_require__(15);
const newRecord_1 = __webpack_require__(56);
...
async function activate(context) {
    ...
    checkAndUpdateSfCli()
        .then(() => {
        (0, outputs_1.showInfo)("Checked Salesforce CLI version.");
        ...
        .then(() => {
        (0, outputs_1.showInfo)("Org statuses checked.");
        setupExistingWatchers(context);
        (0, outputs_1.showInfo)("Activated existing watchers.");
...
async function toggleActivation(context) {
    const workspaceFolders = vscode.workspace.workspaceFolders;
    if (!workspaceFolders || workspaceFolders.length === 0) {
    ...
    try {
        ...
        if (settings['watchersActive']) {
            ...
            (0, outputs_1.showInfo)("SCWD deactivated.");
        }
        else {
            activate(context);
            settings['watchersActive'] = true;
            (0, outputs_1.showInfo)("SCWD activated.");
        }
        fs.writeFileSync(settingsPath, JSON.stringify(settings, null, 2));
    }
    catch (error) {
...
function setupExistingWatchers(context) {
    ...
    if (orgAlias && existingMappings) {
        existingMappings.forEach(mapping => {
            attachSaveListener_1.WatcherManager.attach(mapping, orgAlias);
        });
    }
}
function deactivateWatchers() {
    attachSaveListener_1.WatcherManager.removeAllWatchers();
}
...
async function checkAndUpdateSfCli() {
    ...
    try {
        ...
        if (stderr) {
            (0, outputs_1.showError)(`Error checking Salesforce CLI update status: ${stderr}`);
            return;
        }
        const status = JSON.parse(stdout);
        if (status.needsUpdate) {
            (0, outputs_1.showInfo)('Salesforce CLI update is required. Updating now...');
            const updateCommand = 'sf update';
            await execAsync(updateCommand);
            (0, outputs_1.showInfo)('Salesforce CLI has been updated successfully.');
        }
        else {
            (0, outputs_1.showInfo)('Salesforce CLI is up-to-date.');
        }
    }
    catch (error) {
...
async function authenticate() {
    ...
    const orgAlias = vscode.workspace.getConfiguration('storeConnect').get('orgAlias') || alias;
...
const outputs_1 = __webpack_require__(4);
const types_1 = __webpack_require__(7);
const p_queue_1 = __importDefault(__webpack_require__(9));
const attachSaveListener_1 = __webpack_require__(15);
...
/* harmony export */ });
/* harmony import */ var eventemitter3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);
/* harmony import */ var p_timeout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
/* harmony import */ var _priority_queue_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(13);
...
/* harmony export */ });
/* harmony import */ var _lower_bound_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(14);
...
const vscode = __importStar(__webpack_require__(1));
const outputs_1 = __webpack_require__(4);
const salesforceAPI_1 = __webpack_require__(16);
const newRecord_1 = __webpack_require__(56);
class WatcherManager {
    ...
    static attach(mapping, orgAlias) {
        ...
        const handleFileCreate = async (uri) => {
            if (this.ignoreInitialChange.has(uri.fsPath)) {
                this.ignoreInitialChange.delete(uri.fsPath);
                return;
            }
            ...
            if (!existingMapping) {
                (0, outputs_1.log)(`New file detected: ${uri.fsPath}`);
                await (0, newRecord_1.newRecord)(uri); // Trigger newRecord command for new files
            }
        };
    ...
    static removeAllWatchers() {
        this.activeWatchers.forEach((watcher, path) => {
            watcher.dispose();
            (0, outputs_1.log)(`Watcher disposed for: ${path}`);
        });
...
var CombinedStream = __webpack_require__(19);
...
var util = __webpack_require__(20);
var Stream = (__webpack_require__(21).Stream);
var DelayedStream = __webpack_require__(22);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __webpack_require__(44)("follow-redirects");
    }
    catch (error) { /* */ }
